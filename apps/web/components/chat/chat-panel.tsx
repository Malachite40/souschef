...
function hasActiveToolCall(messages: Array<{ parts: Array<{ type: string; state?: string }> }>, toolName?: string): boolean {
...
interface SidebarContentProps {
    conversations: Array<{ id: string; title: string | null; model: string | null }> | undefined;
...
export function ChatPanel() {
    const { conversationId, model, setConversationId, setModel } =
        useChatStore();
    ...
    const sendWithConversation = useCallback(
        ...
        [createConversation, setConversationId, sendMessage, utils.chat.listConversations],
    );
    ...
    return (
        <div className="flex h-screen md:h-[calc(100vh-3.5rem)]">
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                ...
                <div className="relative min-h-0 flex-1">
                    <div ref={scrollContainerCallbackRef} className="h-full overflow-y-auto p-4">
                        <div className="mx-auto max-w-3xl">
                                ...
                                <div className="flex h-full items-center justify-center pt-16 pb-8">
                                    <div className="text-center">
                                        ...
                                        <p className="mb-6 text-sm text-muted-foreground">
                                            Ask me for any recipe and I&apos;ll search
                            ...
                            {status === 'submitted' && <ToolCallIndicator message="Thinking..." />}
                            {isLoading && hasActiveToolCall(messages, 'search_recipes') && <ToolCallIndicator message="Searching for recipes..." />}
                            {isLoading && hasActiveToolCall(messages, 'browse_recipes') && <ToolCallIndicator message="Finding recipes..." />}
                            {error && (
                ...
                <div className="border-t p-3">
                    <div className="mx-auto max-w-3xl space-y-2">
                        ...
                        <p className="text-center text-[11px] text-muted-foreground">
                            SousChef searches the web for recipes. Always verify cooking times.
                        </p>
                    </div>
                </div>
            </div>
